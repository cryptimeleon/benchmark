package de.upb.crypto.benchmark.benchmarks.group;
...
public class GroupImplPerformanceTest {
    private GroupImpl group1;
    private GroupImpl group2;
    private int testRepetitions;

    public GroupImplPerformanceTest(GroupPerformanceTestParams testParams) {
    ...
    public void evaluateExponentiationSpeedUp() {
        ...
        for (int i = 0; i < testRepetitions; i++) {
            GroupElementImpl group1Base = group1.getUniformlyRandomElement();
            BigInteger group1Exponent = new Zp(group1.size()).getUniformlyRandomElement().getInteger();
            GroupElementImpl group1Result = group1Base;

            GroupElementImpl group2Base = group2.getUniformlyRandomElement();
            BigInteger group2Exponent = new Zp(group2.size()).getUniformlyRandomElement().getInteger();
            GroupElementImpl group2Result = group2Base;
